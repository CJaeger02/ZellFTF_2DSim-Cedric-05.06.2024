...
machine = dict(
    ...
    loading_time_input=[0],  # s | loading time of the input, the first entry is for the first product etc...
    loading_time_output=[0],  # s | loading time of the output, the first entry is for the first product etc...
    ...
    base_color=[100, 100, 255]  # Color of the main block
)

warehouse = dict(
    id='W' + str(0),  # id of the warehouse
    name='default_warehouse',  # name of the warehouse
    length=1,  # m | length of the warehouse
    ...
    pos_output=[0, 0],  # x-y_position of source (output) in warehouse grid
    ...
    loading_time_output=[0],  # s | loading time of the source (output), the first entry is for the first product etc...
    loading_time_input=[0],  # s | loading time of the drain (input), the first entry is for the first product etc...
    ...
    base_color=[255, 150, 100]  # Color of the main block
)
